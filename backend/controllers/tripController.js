...
{
  "itinerary": [{"dayNumber": 1, "activities": [{"title": "Activity", "description": "Details", "estimatedCostUSD": 20, "timeOfDay": "Morning"}]}],
  "hotels": [{"name": "Hotel", "tier": "Budget", "estimatedCostNightUSD": 60, "rating": "4.2/5"}, {"name": "Hotel2", "tier": "Mid Range", "estimatedCostNightUSD": 120, "rating": "4.5/5"}, {"name": "Hotel3", "tier": "Luxury", "estimatedCostNightUSD": 280, "rating": "4.8/5"}],
  "estimatedBudget": {"transport": 200, "accommodation": 300, "food": 150, "activities": 120, "total": 770},
  "packingList": [{"item": "Passport", "category": "Documents", "isPacked": false}, {"item": "Comfortable shoes", "category": "Clothing", "isPacked": false}, {"item": "Sunscreen", "category": "Gear", "isPacked": false}]
}
Include exactly ${durationDays} days with 3-4 activities each.`;
  ...
  try {
    ...
    const newTrip = new Trip({
      userId, destination, durationDays: parseInt(durationDays),
...
exports.regenerateDay = async (req, res) => {
  ...
  try {
    ...
    const prompt = `Regenerate Day ${dayNumber} for a trip to ${trip.destination}. Budget: ${trip.budgetTier}. User feedback: "${feedback || "Fresh activities"}". Respond ONLY with JSON: {"dayNumber": ${dayNumber}, "activities": [{"title": "Activity", "description": "Details", "estimatedCostUSD": 20, "timeOfDay": "Morning"}]}`;
